...
var R = je, W = class {
  ...
  constructor({
    ...
    if (this.refreshTokenAllowedScope = Z, this.extraQueryParams = le, this.extraTokenParams = B, this.extraHeaders = ee, this.dpop = te, this.dpop && !((Y = this.dpop) != null && Y.store))
...
}, Ue = class Be extends Fe {
  constructor({
    silentRequestTimeoutInSeconds: t = Ve
  }) {
    super(), this._logger = new f("IFrameWindow"), this._timeoutInSeconds = t, this._frame = Be.createHiddenIframe(), this._window = this._frame.contentWindow;
  }
...
const zt = ({
  ...
  children: e,
  Login: t
}) => /* @__PURE__ */ H.jsx(Jt, { ...Kt, children: /* @__PURE__ */ H.jsx(zt, { Login: t, children: e }) });
export {
